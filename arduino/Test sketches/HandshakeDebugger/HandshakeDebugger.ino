...
void mpr121_setup(void)
{
  ...
  */
  ...
  MPR121.setRegister(ECR, 0x01); // Baseline tracking on - only first electrode
}

void mpr121_setup2(void)
{
  if (!MPR121.begin()) {
    Serial.println("Error: reset failed!");
    return;
